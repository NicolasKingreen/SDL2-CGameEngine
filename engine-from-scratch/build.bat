...
set libs="C:\Users\Nicolas Kingreen\c\sdl-game\lib\SDL2main.lib" "C:\Users\Nicolas Kingreen\c\sdl-game\lib\SDL2.lib" 

CL /Zi /I "C:\Users\Nicolas Kingreen\c\sdl-game\include" %files% /link %libs% /OUT:mygame.exe